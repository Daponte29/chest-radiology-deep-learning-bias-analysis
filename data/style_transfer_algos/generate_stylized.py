...
Usage:
    ...
    python -m data.style_transfer_algos.generate_stylized --transforms gaussian_blur --splits train
    python -m data.style_transfer_algos.generate_stylized --workers 8
"""
...
def _process_image(job: tuple) -> list[str]:
    ...
    from data.style_transfer_algos.texture.gaussian_blur import apply as _gb
    from data.style_transfer_algos.texture.patch_shuffle import apply as _ps
    from data.style_transfer_algos.shape.canny_edge      import apply as _ce
    from data.style_transfer_algos.shape.patch_rotation  import apply as _pr
